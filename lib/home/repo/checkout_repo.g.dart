...
@ProviderFor(becobankNames)
final becobankNamesProvider = AutoDisposeFutureProvider<List<String>>.internal(
  becobankNames,
  name: r'becobankNamesProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$becobankNamesHash,
  dependencies: null,
